      ...
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        <div className="flex min-h-full flex-col justify-center px-2 py-12 lg:px-8">
          ...
          <div className="sm:mx-auto sm:w-full md:max-w-xl">
            <Logo/>
            <h2 className="mt-10 text-center text-sm sm:text-2xl/9 font-bold tracking-tight text-gray-900">
              Create Your Account
            </h2>
            <p className=''>Start organizing your projects and tasks in one place.</p>
          </div>
